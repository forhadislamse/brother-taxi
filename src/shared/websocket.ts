...
//             console.log(
//               `✅ Authenticated ${user.role}: ${user.id} | Total Drivers: ${onlineDrivers.size} | Total Riders: ${onlineRiders.size}`
//             );
...
//                 // select: { id: true, userId: true }, // Rider ID আনতে হবে
//               });

//               console.log(
//                 "Transport.userId (Rider ID):",
//                 transport?.userId || "❌ Not found"
//               );
...
//                   })
//                 );
//                 console.log("📨 Location sent to Rider:", transport.userId);
//               } else {
//                 console.log("⚠️ Rider not online:", transport.userId);
//               }
//             } catch (err) {
